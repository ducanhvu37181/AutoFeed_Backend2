...
public class SchedulesController : ControllerBase
{
    ...
    public SchedulesController(AutoFeed_Backend_Services.Interfaces.IServiceProvider provider)
    {
        _service = provider.ScheduleService;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateScheduleDto model)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update([FromBody] UpdateScheduleDto model)
    {
        if (model == null) return BadRequest();
        var entity = model.ToEntity();
